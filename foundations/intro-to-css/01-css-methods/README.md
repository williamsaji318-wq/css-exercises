...
* `div`: a red background, white text, a font size of 32px, center aligned, and bold#check
* `p`: a green background, white text, and a font size of 18px#check
* `button`: an orange background and a font size of 18px#check
